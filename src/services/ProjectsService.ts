...
export class ProjectsService {
  static async getProjects(year: boolean, professor: boolean): Promise<AxiosResponse<ProjectsDTO[]>> {
    const response = await apiBack.get(`projects?groupByProfessor=${professor}&groupByYear=${year}`, {
